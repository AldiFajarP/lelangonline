                ...
                <form action="{{ route('masterklasifikasi.update') }}" method="post">
                    ...
                    <div class="col-md-6" align="center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly required="required" name="KodeKlasifikasi" class="form-control form-group--inline" value="{{$kla->KodeKlasifikasi}}">
                            @endforeach
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            @foreach($klasifikasi as $kla)
                            <input type="text" required="required" name="NamaKlasifikasi" class="form-control" value="{{$kla->NamaKlasifikasi}}">
                            @endforeach
                        </div>
