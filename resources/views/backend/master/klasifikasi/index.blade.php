        ...
        <div class="card">
            ...
            <div class="card-title" style="background-color:white;">
                @if(session()->get('created'))
                    ...
                    <a href="{{ url('/admin/master/klasifikasi/create')}}" class="btn btn-success">
    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color:#0077ff; padding: 0.1% 0.1% 0.1% 0.1%;">
                <h5 align="center" style="color:white;">Data Klasifikasi</h5>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-hover" id="table1" name="table1" style="text-align:center;">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ url('/admin/master/klasifikasi/edit/'. $mk->KodeKlasifikasi)}}" class="btn btn-warning btn-xs">
                                    <i class="fa fa-pen" aria-hidden="true" style="color:white;"> Ubah</i>
                                </a>
                                <a href="{{ url('/admin/master/klasifikasi/destroy/'. $mk->KodeKlasifikasi)}}" class="btn btn-danger btn-xs">
