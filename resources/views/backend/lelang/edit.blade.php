    ...
    <div class="col-md-12" align="center">
        <div class="card">
            <div class="card-header" style="background-color: #0077ff;">
                <h3 style="color:white;">Ubah Data Lelang {{$dl->KodeLelang}}</h3>
            </div>  
            <div class="x_panel">
                <div class="x_content">
                    <div class="col-md-6" align="center">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" readonly required="required" name="KodeLelang" class="form-control form-group--inline" value="{{$dl->KodeLelang}}">
                        </div>
            ...
            <div class="col-md-12">                
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="TanggalMulai" id="inputDate1" value="{{$dl->TanggalMulai}}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="JamMulai" id="inputTime1" value="{{$dl->JamMulai}}">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                        </div>
                ...
                <div class="col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="TanggalPenutupan" id="inputDate2" value="{{$dl->TanggalPenutupan}}">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="JamPenutupan" id="inputTime2" value="{{$dl->JamPenutupan}}">
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                        </div>
                ...
                <div class="col-md-8">
                    ...
                    <table class="table table-bordered table-hover" id="table1" name="table1" style="text-align:center;">
                            ...
                            <tbody>
                                <tr>                                    
                                    <td>
                                        <input type="text" name="OpenBid" id="OpenBid" value="{{$dl->OpenBid}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;      
                                        <input type="text" name="ShowOpenBid" id="ShowOpenBid" value="Rp {{number_format($dl->OpenBid)}}.-" class="form-control" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="BuyItNow" id="BuyItNow" value="{{$dl->BuyItNow}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;
                                        <input type="text" name="ShowBuyItNow" id="ShowBuyItNow" value="Rp {{number_format($dl->BuyItNow)}}.-" class="form-control" readonly>
                                    </td>
                                    <td>
            ...
            <div class="col-md-8">
                    ...
                    <table class="table table-bordered table-hover" id="table1" name="table1" style="text-align:center;">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <input type="text" name="Kelipatan1" id="Kelipatan1" value="{{$dl->Kelipatan1}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;      
                                        <input type="text" name="ShowKelipatan1" id="ShowKelipatan1" value="Rp {{number_format($dl->Kelipatan1)}}.-" class="form-control" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="Kelipatan2" id="Kelipatan2" value="{{$dl->Kelipatan2}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;
                                        <input type="text" name="ShowKelipatan2" id="ShowKelipatan2" value="Rp {{number_format($dl->Kelipatan2)}}.-" class="form-control" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="Kelipatan3" id="Kelipatan3" value="{{$dl->Kelipatan3}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;      
                                        <input type="text" name="ShowKelipatan3" id="ShowKelipatan3" value="Rp {{number_format($dl->Kelipatan3)}}.-" class="form-control" readonly>
                                    </td>
                                    <td>
                                        <input type="text" name="Kelipatan4" id="Kelipatan4" value="{{$dl->Kelipatan4}}" class="form-control" onkeypress="return onlyNumberKey(event)" 
                   maxlength="11">&nbsp;
