...
<!-- The Modal -->
                    ...
                    <div class="col-md-6" align="center">
                                ...
                                <div class="form-group">
                                    <label class="unselect">Status Lelang : </label>
                                    <input type="text" readonly name="Keterangan" class="form-control" value="{{$db->StatusLelang}}">
                                </div>
                                <br/><br/>
                            </div>  
                            @endforeach
                    <div style="text-align:center;">
                            <a href="/admin/databarang/konfirmasi" class="btn btn-danger">Kembali</a>
                        </div>
                        <br/>         
        </div>    
    </div>
