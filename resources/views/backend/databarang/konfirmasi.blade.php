    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header" style="background-color:#0077ff; padding: 0.1% 0.1% 0.1% 0.1%;">
                <h5 align="center" style="color:white;" class="unselect">Data Barang Terkonfirmasi</h5>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-hover" id="table1" name="table1" style="text-align:center;">
                    ...
                    <tbody>
                        ...
                        <tr class="unselect">
                            ...
                            <td>{{ $db->NamaBarang}}</td>
                            <td>{{ $db->TipeBarang}}</td>
                            <td>{{ $db->StatusLelang}}</td>
                            <td>

                                <a href="{{ url('/admin/databarang/detailkonfirmasi/'. $db->KodeBarang)}}" class="btn btn-success btn-xs">
                                    <i class="fa fa-eye" aria-hidden="true" style="color:white;"> Detail</i>
                                </a>
                                <a href="{{ url('/admin/databarang/batalkonfirmasi/'. $db->KodeBarang)}}" class="btn btn-danger btn-xs">
                                    <i class="fa fa-arrow-left" aria-hidden="true" style="color:white;"> Batal</i>
                                </a>
                            </td>
                        </tr>
                        @endforeach
